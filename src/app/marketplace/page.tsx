    ...
    <div className="min-h-screen bg-slate-900">
      ...
      <div className="bg-gradient-to-b from-blue-900/50 to-transparent py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-400">Projets digitaux prêts à lancer</p>
        </div>
      </div>
        ...
        {error ? (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {projects.map((project) => (
              ...
              >
                <div className="aspect-video bg-gradient-to-br from-blue-600 to-indigo-600 relative">
                  ...
                  <div className="flex justify-between items-center mt-4 pt-4 border-t border-white/10">
                    <div className="flex items-center gap-2">
                      {project.avg_rating > 0 && (
                        <span className="text-yellow-400 text-sm">★ {project.avg_rating.toFixed(1)}</span>
                      )}
                      {project.purchase_count > 0 && (
                        <span className="text-gray-500 text-sm">{project.purchase_count} ventes</span>
                      )}
                    </div>
